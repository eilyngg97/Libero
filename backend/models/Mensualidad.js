...
const MensualidadSchema = new mongoose.Schema({
  ...
  bloqueo_recargo_automatico: { type: Boolean, default: false },
  bloqueo_recargo_automatico_fecha: { type: Date },
  bloqueo_recargo_automatico_actor_id: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
  bloqueo_recargo_automatico_nota: { type: String },
